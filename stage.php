 ...
 if(isset($_REQUEST["btndelete"]))
{
  ...
  try
  {
    $stmt_del = $obj->con1->prepare("DELETE FROM `stage` WHERE id = ?");
...
function deletedata(id,stage) {
    $('#deleteModal').modal('toggle');
    $('#delete_id').val(id);
    $('#delete_record').html(stage);
}
</script>
<!-- Basic Modal -->
        ...
        <div class="modal-content">
            ...
            <form method="post" action="stage.php">
                ...
                <div class="modal-body">
                    Are you sure you want to delete "<span id="delete_record"></span>" Stage record?
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:deletedata('<?php echo $row["id"]?>','<?php echo $row["stage"] ?>');"><i
