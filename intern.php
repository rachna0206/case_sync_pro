 ...
 if(isset($_REQUEST["btndelete"]))
{
  ...
  try
  {
    $stmt_del = $obj->con1->prepare("DELETE FROM `interns` WHERE id = ?");
...
function add_data() {
    eraseCookie("edit_id");
    eraseCookie("view_id");
    window.location = "intern_add.php";
}
        ...
        <div class="modal-content">
            ...
            <form method="post" action="intern.php">
                ...
                <div class="modal-body">
                    Are you sure you want to delete "<span id="delete_record"></span>" record?
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
                            $stmt = $obj->con1->prepare("SELECT *, date_format(date_time,'%d-%m-%Y') as doj FROM `interns` ORDER BY `id` DESC");
                            $stmt->execute();
