...
if (!isset($_SESSION["intern_userlogin"])) {
  header("location:login_intern.php");
}
  ...
  <div id="noti_list">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $_SESSION["intern_username"] ?></span>
          ...
          <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="logout_intern.php">
